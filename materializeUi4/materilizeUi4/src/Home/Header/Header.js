      ...
      <AppBar position="static" style={{backgroundColor: '#232526'}}>
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
            <IconButton aria-label=" " color="inherit" >
            <Link style={{textDecoration:'none', color:'white', fontSize: '12px'}} to='/home'>Home</Link>
            </IconButton>
            <IconButton aria-label=" " color="inherit" >
            <Link style={{textDecoration:'none', color:'white', fontSize: '12px'}}   to='/white'>White</Link>
            </IconButton>
            <IconButton aria-label=" " color="inherit">
            <Link style={{textDecoration:'none', color:'white', fontSize: '12px'}}   to='/techOut'>Tech-Out</Link>
            </IconButton>
            <IconButton aria-label=" " color="inherit">
            <Link style={{textDecoration:'none', color:'white', fontSize: '12px'}}   to='/vintage'>Vintage</Link>
            </IconButton>
            <IconButton aria-label=" " color="inherit">
            <Link style={{textDecoration:'none', color:'white', fontSize: '12px'}} to='/colorMagic'>Color Magic</Link>
            </IconButton>
