...
export default function PrimarySearchAppBar() {
  ...
  const renderCarousel = (
    ...
    <div className={"carousel-image"}>
        <img src={'https://i.pinimg.com/474x/79/88/fb/7988fb9e297a63ab3b60a2f41e6bd0f3.jpg'} />
    </div>
    <div className={"carousel-image"}>
        <img src={'https://i.pinimg.com/474x/31/70/5f/31705f3440ca23699ae7dd60af491abe.jpg'} />
    </div>
    <div className={"carousel-image"}>
        <img src={'https://i.pinimg.com/474x/ef/41/dc/ef41dc14e52a80bcfadaeda3ae24b641.jpg'} />
    </div>
</Carousel>
    )
